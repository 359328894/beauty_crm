<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:92:"C:\phpStudy\PHPTutorial\WWW\fastadmin.im\public/../application/admin\view\user\user\add.html";i:1563675583;s:83:"C:\phpStudy\PHPTutorial\WWW\fastadmin.im\application\admin\view\layout\default.html";i:1547349022;s:80:"C:\phpStudy\PHPTutorial\WWW\fastadmin.im\application\admin\view\common\meta.html";i:1547349022;s:82:"C:\phpStudy\PHPTutorial\WWW\fastadmin.im\application\admin\view\common\script.html";i:1547349022;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                <?php echo build_select('row[store_id]', $storeslist, '', ['class'=>'form-control selectpicker','data-rule'=>'required']); ?>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-xs-12 col-sm-2"><?php echo __('Group.name'); ?>:</label>
            <div class="col-xs-12 col-sm-8">
                <?php echo build_select('row[group_id]', $grouplist, '', ['class'=>'form-control selectpicker','data-rule'=>'required']); ?>
            </div>
        </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Cardnum'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-cardnum" class="form-control" name="row[cardnum]" type="text" value="0">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-birthday" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[birthday]" type="text" value="<?php echo date('Y-m-d'); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-jointime" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[jointime]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', ['1'=>__('Status 1'), '0'=>__('Status 0')], '1'); ?>
        </div>
    </div>
